...
LONG_TERM_MIN_HOLD_HOURS = int(os.getenv("LONG_TERM_MIN_HOLD_HOURS", "72"))
LONG_TERM_MAX_PORTFOLIO_DRAWDOWN_PCT = float(os.getenv("LONG_TERM_MAX_PORTFOLIO_DRAWDOWN_PCT", "0.25"))
LONG_TERM_MAX_TOTAL_EXPOSURE_PCT = float(os.getenv("LONG_TERM_MAX_TOTAL_EXPOSURE_PCT", "0.75"))
LONG_TERM_MAX_SYMBOL_EXPOSURE_PCT = float(os.getenv("LONG_TERM_MAX_SYMBOL_EXPOSURE_PCT", "0.10"))
